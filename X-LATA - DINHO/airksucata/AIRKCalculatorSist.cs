...
namespace airksucata
{
...

    {
        ...
        private void InitializeListView()
        {
            ...
            listRegistros.Columns.Add("Material", 160, HorizontalAlignment.Left);
            listRegistros.Columns.Add("Valor KG", 70, HorizontalAlignment.Left);
            listRegistros.Columns.Add("Peso", 80, HorizontalAlignment.Left);
            listRegistros.Columns.Add("Total", 100, HorizontalAlignment.Left);
            listRegistros.Columns.Add("Data e Hora", 150, HorizontalAlignment.Left);
        ...
        {
            string consulta = "SELECT id_registro, materialNome, materialValor, inputValor, totalPagar, dataHoraAtual FROM pedidos_impressos ORDER BY id_registro DESC LIMIT 10"; // Substitua por sua consulta SQL
        ...
        private void CreateMaterialButton(int row, int col, string nome)
        {
            ...
            newButton.Width = 203; // Defina a largura desejada
            newButton.Height = 50; // Defina a altura desejada
            newButton.BackColor = Color.FromArgb(0, 140, 0); // Cor de fundo
            newButton.ForeColor = Color.White; // Cor do texto
            newButton.Font = new Font("Arial", 9, FontStyle.Bold); // Fonte e tamanho do texto
