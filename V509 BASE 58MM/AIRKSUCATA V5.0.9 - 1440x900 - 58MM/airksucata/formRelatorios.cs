...
namespace airksucata
{
    public partial class formRelatorios : Form
    {
        ...
        private void ImprimirRelatorioCompra(object sender, PrintPageEventArgs e)
        {
            ...
            string periodoInicio = $"De: {listViewResultado.Items[0].SubItems[5].Text}";
            string periodoFim = $"Até: {listViewResultado.Items[listViewResultado.Items.Count - 1].SubItems[5].Text}\n";
