namespace airksucata
{
    partial class AIRKLoadSplash
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Location = new Point(16, 346);
            label2.Name = "label2";
            ...
            label1.BackColor = Color.FromArgb(4, 45, 46);
            label1.Font = new Font("Avignon Pro", 8F, FontStyle.Regular, GraphicsUnit.Point);
            label1.ForeColor = Color.FromArgb(0, 100, 100);
            label1.Location = new Point(16, 390);
            label1.Name = "label1";
            label1.Size = new Size(198, 14);
            label1.TabIndex = 8;
            label1.Text = "Versão atual 5.0.9 - 30/11/2023 - 14:34";
