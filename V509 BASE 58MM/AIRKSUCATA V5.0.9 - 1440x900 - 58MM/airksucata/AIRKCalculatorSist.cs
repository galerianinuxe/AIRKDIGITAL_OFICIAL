...
namespace airksucata
{
...

    {
        ...
        private void InitializeListView()
        {
            ...
            listRegistros.Columns.Add("Nome", 120, HorizontalAlignment.Left);
        ...
        private void CreateMaterialButton(int row, int col, string nome)
        {
            ...
            newButton.Width = 170; // Defina a largura desejada
            newButton.Height = 40; // Defina a altura desejada
            newButton.BackColor = Color.FromArgb(0, 140, 0); // Cor de fundo
            newButton.ForeColor = Color.White; // Cor do texto
            newButton.Font = new Font("Arial", 10, FontStyle.Bold); // Fonte e tamanho do texto
        ...
        private void AtualizarQuantidadeRegistros()
        {
            ...
            // Adicione 1 se a quantidade for menor que 20 e maior ou igual a 0
            quantidadeRegistros = (quantidadeRegistros < 20 && quantidadeRegistros >= 0) ? quantidadeRegistros : quantidadeRegistros;

            // Exiba a quantidade no Label
            lbQuantRegistros.Text = $"{quantidadeRegistros}";

            // Verifique se atingiu a quantidade máxima
            if (quantidadeRegistros >= 20)
            {
        ...
        private void btnZerar_Click_2(object sender, EventArgs e)
        {
