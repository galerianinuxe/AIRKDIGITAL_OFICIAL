...
namespace airksucata
{
    public partial class FormComprovante : Form
    {
        ...
        private void ImprimirRecibo(object sender, PrintPageEventArgs e)
        {
            ...
            Font contatoFonte = new Font("Arial", 14, FontStyle.Bold);
            ///////////////////////////////////////////////////////
            string local = "";
            ...
            linhaAtual += 5 + margemInterna; // Altura da imagem mais a margem interna
            ...
            linhaAtual += 60 + margemInterna; // Altura da imagem mais a margem interna
            e.Graphics.DrawString(cabecalhoCompleto, fonteCabecalho, Brushes.Black, new Rectangle(0, linhaAtual, e.PageBounds.Width, (int)tamanhoCabecalho.Height));
            linhaAtual += (int)tamanhoCabecalho.Height + margemInterna; // Pular duas linhas após o cabeçalho

            // Larguras específicas das colunas
            int[] largurasColunas = { 50, 40, 40, 70 }; // Ajuste conforme necessário
            ...
            // Ajuste de posição vertical
            int alturaTextoAdicionalCreditos = (int)e.Graphics.MeasureString("X", fonteDados).Height + margemInterna;
            ...
            e.Graphics.DrawString(textoAdicional1, fonteTextoAdicional, Brushes.Black, new Point(margemInterna, linhaAtual));
            linhaAtual += (int)alturaTextoAdicionalCreditos;
            e.Graphics.DrawString(textoAdicional2, fonteTextoAdicional, Brushes.Black, new Point(margemInterna, linhaAtual));
            linhaAtual += (int)alturaTextoAdicionalCreditos;
        }
