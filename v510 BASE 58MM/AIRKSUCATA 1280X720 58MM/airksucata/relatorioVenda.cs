...
namespace airksucata
{
    public partial class relatorioVenda : Form
    {
        ...
        private void ImprimirRelatorioUnitario(object sender, PrintPageEventArgs e)
        {
            ...
            Font fonteRodape = new Font("Arial", 13, FontStyle.Bold);
            ...
            // Cabeçalho
            string cabecalho = "Relatório Venda Unidade";
            string periodoInicio = $"Até: {listViewResultadoUnid.Items[0].SubItems[5].Text}";
            string periodoFim = $"De: {listViewResultadoUnid.Items[listViewResultadoUnid.Items.Count - 1].SubItems[5].Text}";
            ...
            int[] largurasColunas = { 40, 40, 50, 20, 50, 0 };
            ...
            string textoTotalVendas = $"Total em Vendas: \n{lbValorTotalUnit.Text}\n";
            string textoQuantidade = $"Quantidade: {lbQuantidade.Text}\n";

            // Ajuste de posição vertical
            int alturaTextoAdicional = (int)e.Graphics.MeasureString("X", fonteRodape).Height + margemInterna;
            linhaAtual += alturaTextoAdicional;
            e.Graphics.DrawString(textoTotalVendas, fonteRodape, Brushes.Black, new Point(margemInterna, linhaAtual));
            linhaAtual += alturaTextoAdicional;
            linhaAtual += alturaTextoAdicional;
            e.Graphics.DrawString(textoQuantidade, fonteRodape, Brushes.Black, new Point(margemInterna, linhaAtual));
            linhaAtual += alturaTextoAdicional;
        ...
        private void ImprimirRelatorioPeso(object sender, PrintPageEventArgs e)
        {
            ...
            // Cabeçalho
            string cabecalho = "Relatório Venda por Peso";
            string periodoInicio = $"Até: {listViewResultadoPeso.Items[0].SubItems[5].Text}";
            string periodoFim = $"De: {listViewResultadoPeso.Items[listViewResultadoPeso.Items.Count - 1].SubItems[5].Text}";
            string cabecalhoCompleto = $"{cabecalho}\n\n{periodoFim}\n{periodoInicio}\n";
            ...
            // Larguras específicas das colunas 80MM
            //int[] largurasColunas = { 65, 60, 65, 45, 50, 0 };
            //LARGURA PARA 58MM
            int[] largurasColunas = { 40, 40, 50, 20, 50, 0 };
            ...
            linhaAtual += margemInterna;
            string textoTotalVendas = $"Total em Vendas: \n{lbValorTotalKg.Text}\n";
            string textoQuantidade = $"Peso Total: \n{lbPesoTotal.Text}\n";
