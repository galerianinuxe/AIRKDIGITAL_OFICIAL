namespace airksucata
{
    public partial class formCadastro : Form
    {
        ...
        private void CriarNovoArquivoComDataHoraAtual30Dias()
        {
            ...
            string novoArquivoPath = $"airkdigitalwpp11952785087direitosreservadosmarcaregistrada30_{dataHoraAtual}.arq";
        ...
        {
            string dataHoraAtual = DateTime.Now.ToString("yyyyMMddHHmmss");
            string novoArquivoPath = $"airkdigitalwpp11952785087direitosreservadosmarcaregistrada7_{dataHoraAtual}.arq";
