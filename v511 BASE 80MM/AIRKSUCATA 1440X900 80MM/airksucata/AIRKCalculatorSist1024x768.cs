...
{
    public partial class AIRKCalculatorSist1024x768 : Form

    {
        ...
        public AIRKCalculatorSist1024x768()
        {
            InitializeComponent();
            InitializeListView();
            LoadMaterialButtons();
        ...
        private void CreateMaterialButton(int row, int col, string nome)
        {
            ...
            newButton.Width = 171; // Defina a largura desejada
            newButton.Height = 45; // Defina a altura desejada
